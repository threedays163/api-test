 ...
 * @since 1.
 */
@Table(name = "lesson_table_relate_template")
public class LessonTableRelateTemplateEntity implements Serializable {
    private static final long serialVersionUID = 9490420281716439L;
