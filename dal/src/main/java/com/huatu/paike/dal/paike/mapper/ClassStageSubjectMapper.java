...
public interface ClassStageSubjectMapper extends Mapper<ClassStageSubject> {
     ...
     * @return
     */
    int updateStatusByCssbList(@Param("status") int status, @Param("updateTime") Date updateTime, @Param("list") List<ClassStageSubject> list);
    /**
     * 更新科目的实际上课人数
     *
     * @param classID
     ...
     * @return
     */
    int insertBatchSubject(Collection<ClassStageSubject> csss);
    ...
    List<ClassStageSubject> getByIds(@Param("list") Collection<Long> ids);
    /**
     * 批量更新
     *
     * @param cssList
     */
    void updateBatch(List<ClassStageSubject> cssList);
     ...
     * @param cssList
     */
    void updateBatchByCssb(List<ClassStageSubject> cssList);

    List<String> queryOrderNos(List<Long> list);

    List<ClassStageSubject> queryCssByLessonTableDetailId(@Param("lessonTableDetailId") Long lessonTableDetailId);
}